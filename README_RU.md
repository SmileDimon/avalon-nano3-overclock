...
## 🔬 Дамп и Анализ Прошивки

Хотите углубиться? Смотрите полное руководство по дампингу прошивки: [**FIRMWARE_DUMP.md**](FIRMWARE_DUMP.md)

Темы:
- Извлечение через binwalk
- Анализ UBI разделов
- Модификация btcminer
- Сборка SWU образов
